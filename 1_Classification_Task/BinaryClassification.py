...
#Base Folder with ids and non-id images
...
model.save_weights("modelv2_colour_4conv.h5")
...
test_df['id_present'] = [0 if x<=0.7 else 1 for x in predict]
...
#view images wrongly classified
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('./1_classification/Test/Non_Ids/n03792782_276.png')
plt.imshow(img)
